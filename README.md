...
You can download the Data only from the [DZ-Wilaya-Data](https://github.com/Ta7lilCrew/DZ-Wilaya-Data) repository, and consider visiting the [Ta7lil Crew](https://github.com/Ta7lilCrew) GitHub account for more Data about Algeria.
